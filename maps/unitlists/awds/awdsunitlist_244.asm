...
AWDSUnitList_244:
	...
	@@UnitBasic Unit_Tank,6,12,AIUnitDefensive
	@@UnitBasic Unit_Tank,13,7,AIUnitDefensive
	...
	@@UnitBasic Unit_Neotank,14,0,AIUnitDefensive
	@@UnitBasic Unit_Neotank,18,5,AIUnitDefensive

...
;ID for Name
	.dw ScriptSFWBillygates
	
;Song ID to play for this CO
	.dh MusicBattleFanfare
...
;AI CO Power Activation Rules
	.dw AIActivateNever+1
	
;CO Power Quotes Strings
	.dh ScriptSFWBillygates+8
	.dh ScriptSFWBillygates+9
	.dh ScriptSFWBillygates+10
	.dh ScriptSFWBillygates+11
	.dh ScriptSFWBillygates+12
	.dh ScriptSFWBillygates+13

;CO Dossier Strings
	.dh ScriptSFWBillygates+3
	.dh ScriptSFWBillygates+4
	.dh ScriptSFWBillygates+5
	.dh ScriptSFWBillygates+6
	
;Victory Quote String
	.dw ScriptSFWBillygates+7

...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSJakeGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSJakeName
	
	;CO Palette (+8)
	.dw GraphicsAWDSJakePalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSJakeFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSJakeHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSJakeSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSJakeMugshot

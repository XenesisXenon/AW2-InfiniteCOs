...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSAdderGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSAdderName
	
	;CO Palette (+8)
	.dw GraphicsAWDSAdderPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSAdderFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSAdderHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSAdderSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSAdderMugshot

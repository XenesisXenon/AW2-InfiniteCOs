...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSVonboltGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSVonboltName
	
	;CO Palette (+8)
	.dw GraphicsAWDSVonboltPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSVonboltFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSVonboltHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSVonboltSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSVonboltMugshot

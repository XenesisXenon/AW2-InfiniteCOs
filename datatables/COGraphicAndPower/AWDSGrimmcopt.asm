...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSGrimmGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSGrimmName
	
	;CO Palette (+8)
	.dw GraphicsAWDSGrimmPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSGrimmFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSGrimmHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSGrimmSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSGrimmMugshot

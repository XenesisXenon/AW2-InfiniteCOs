...
;Starts at 0x084A0090
	...
	.dw GraphicsSFWBillygatesGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsOutrealmName
	
	;CO Palette (+8)
	.dw GraphicsSFWBillygatesPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsSFWBillygatesFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsSFWBillygatesHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsSFWBillygatesSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsSFWBillygatesMugshot

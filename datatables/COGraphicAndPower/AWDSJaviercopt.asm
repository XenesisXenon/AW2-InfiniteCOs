...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSJavierGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSJavierName
	
	;CO Palette (+8)
	.dw GraphicsAWDSJavierPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSJavierFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSJavierHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSJavierSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSJavierMugshot

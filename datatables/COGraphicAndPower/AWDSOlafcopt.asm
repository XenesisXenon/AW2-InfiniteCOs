...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSOlafGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSOlafName
	
	;CO Palette (+8)
	.dw GraphicsAWDSOlafPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSOlafFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSOlafHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSOlafSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSOlafMugshot

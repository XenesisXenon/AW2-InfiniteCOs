...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSJuggerGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSJuggerName
	
	;CO Palette (+8)
	.dw GraphicsAWDSJuggerPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSJuggerFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSJuggerHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSJuggerSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSJuggerMugshot

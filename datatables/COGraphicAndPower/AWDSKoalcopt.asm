...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSKoalGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSKoalName
	
	;CO Palette (+8)
	.dw GraphicsAWDSKoalPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSKoalFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSKoalHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSKoalSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSKoalMugshot

...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSNellGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSNellName
	
	;CO Palette (+8)
	.dw GraphicsAWDSNellPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSNellFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSNellHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSNellSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSNellMugshot

...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSRachelGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSRachelName
	
	;CO Palette (+8)
	.dw GraphicsAWDSRachelPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSRachelFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSRachelHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSRachelSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSRachelMugshot

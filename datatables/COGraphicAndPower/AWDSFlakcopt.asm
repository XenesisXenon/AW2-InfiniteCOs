...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSFlakGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSFlakName
	
	;CO Palette (+8)
	.dw GraphicsAWDSFlakPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSFlakFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSFlakHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSFlakSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSFlakMugshot

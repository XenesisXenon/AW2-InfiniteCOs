...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSGritGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSGritName
	
	;CO Palette (+8)
	.dw GraphicsAWDSGritPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSGritFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSGritHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSGritSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSGritMugshot

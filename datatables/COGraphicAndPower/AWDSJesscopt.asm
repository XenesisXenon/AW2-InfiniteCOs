...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSJessGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSJessName
	
	;CO Palette (+8)
	.dw GraphicsAWDSJessPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSJessFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSJessHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSJessSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSJessMugshot

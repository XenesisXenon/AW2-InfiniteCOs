...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSKindleGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSKindleName
	
	;CO Palette (+8)
	.dw GraphicsAWDSKindlePalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSKindleFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSKindleHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSKindleSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSKindleMugshot

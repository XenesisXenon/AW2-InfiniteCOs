...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSKanbeiGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSKanbeiName
	
	;CO Palette (+8)
	.dw GraphicsAWDSKanbeiPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSKanbeiFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSKanbeiHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSKanbeiSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSKanbeiMugshot

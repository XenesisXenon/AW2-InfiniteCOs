...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSColinGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSColinName
	
	;CO Palette (+8)
	.dw GraphicsAWDSColinPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSColinFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSColinHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSColinSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSColinMugshot

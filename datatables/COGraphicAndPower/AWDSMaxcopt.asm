...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSMaxGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSMaxName
	
	;CO Palette (+8)
	.dw GraphicsAWDSMaxPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSMaxFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSMaxHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSMaxSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSMaxMugshot

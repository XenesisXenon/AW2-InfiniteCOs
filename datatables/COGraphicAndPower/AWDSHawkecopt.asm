...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSHawkeGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSHawkeName
	
	;CO Palette (+8)
	.dw GraphicsAWDSHawkePalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSHawkeFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSHawkeHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSHawkeSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSHawkeMugshot

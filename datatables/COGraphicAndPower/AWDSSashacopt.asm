...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSSashaGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSSashaName
	
	;CO Palette (+8)
	.dw GraphicsAWDSSashaPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSSashaFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSSashaHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSSashaSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSSashaMugshot

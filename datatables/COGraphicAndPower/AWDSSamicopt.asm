...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSSamiGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSSamiName
	
	;CO Palette (+8)
	.dw GraphicsAWDSSamiPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSSamiFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSSamiHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSSamiSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSSamiMugshot

...
;Starts at 0x084A0090
	...
	.dw GraphicsAWDSLashGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsAWDSLashName
	
	;CO Palette (+8)
	.dw GraphicsAWDSLashPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsAWDSLashFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsAWDSLashHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsAWDSLashSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsAWDSLashMugshot

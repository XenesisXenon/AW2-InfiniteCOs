...
;Starts at 0x084A0090
	...
	.dw GraphicsCCOVenomAdderGraphic
	
	;CO Name Graphic Pointer (+4)
	.dw GraphicsCCOVenomAdderName
	
	;CO Palette (+8)
	.dw GraphicsCCOVenomAdderPalette
	
	;Text Box Face Neutral Pointer (+12)
	.dw GraphicsCCOVenomAdderFace
	
	;Text Box Face Happy Pointer (+16)
	.dw GraphicsCCOVenomAdderHappyFace
	
	;Text Box Face Sad Pointer (+20)
	.dw GraphicsCCOVenomAdderSadFace
	
	;Large Partial Face Pointer (+24)
	.dw GraphicsCCOVenomAdderMugshot

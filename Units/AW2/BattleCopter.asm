;Unit_BattleCopter
	...
	setUnitDamagePrimary		Unit_BattleCopter,45,Unit_Infantry
	setUnitDamagePrimary		Unit_BattleCopter,50,Unit_Mech
	...
	setUnitInventionDamage	Unit_BattleCopter,25,01
